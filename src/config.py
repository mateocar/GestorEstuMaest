...
class DefaultSettings(BaseSettings):
    ...
    BASE_DIR: Path = Path(__file__).parent.parent # se graba la ruta del directorio actual y devuelve la ruta
    SECRET_KEY: str = ""
    SQLALCHEMY_DATABASE_URL: str = "default" # define Direccion base datos 
    SQLALCHEMY_TRACK_MODIFICATIONS: bool = False # se le da seguimientos a las modificaiones de la BD
